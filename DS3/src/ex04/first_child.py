...
if __name__ == "__main__":
    if len(sys.argv[:]) == 2:
        ...
        mass = a.file_reader()
        print(mass)
        c1,c2 = Research.Analytics(data=mass).counts(mass)
        print(c1,c2)
        v1,v2 = Research.Analytics(data=mass).fractions(c1,c2)
        print(v1,v2)
        n = Research.Analytics(data=mass).predict_random()
        print(n)
        l = Research.Analytics(data=mass).predict_last()
        print(l)
